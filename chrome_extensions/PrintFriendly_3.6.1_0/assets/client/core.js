...
window.printInNewTab = async function (page) {
  ...
  await chrome.tabs.create({
    url: `${chrome.runtime.getURL('printInNewTab.html')}?id=${id}`,
    selected: true,
  });
};
...
messageBus.listen('pf-core', {
  ...
  PfPDFDownloadFail: function(payload) {
    toolbar.showError(
      '<b>There was a error during PDF generation.</b>'
    );
  },
...
var core = {
  ...
  createAlgoIframe: function() {
    ...
    if (pfData.config.isExtension) {
      ...
      algoIframe.src = "/assets/client/algo-236e4dac13bb920347314f9cb9010bace66713149be3df3ba48694f6ed8b2db0.html";
      algoIframe.onload = function() {
